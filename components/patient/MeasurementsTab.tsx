...
export const MeasurementsTab: React.FC<{ patient: Patient; onUpdate: (p: Patient) => void; onNavigateToEvaluations: () => void }> = ({ patient, onUpdate, onNavigateToEvaluations }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        {/* Fila título + ojito — siempre en la misma línea */}
        ...
        {/* Botón Agregar — debajo en móvil, a la derecha en sm+ */}
        <div className="flex flex-col items-start sm:items-end gap-1.5" onClick={e => e.stopPropagation()}>
          <button
            onClick={handleAdd}

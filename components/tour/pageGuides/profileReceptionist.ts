...
// Factory porque los pasos de Vinculación con Nutricionistas y Configuración de
// Sistema necesitan expandir esas secciones (colapsadas por default) antes de
// resaltarlas — mismo patrón que getMenuSec1Steps en pageGuides/menuForm.ts.
export function getProfileReceptionistGuideSteps(
  expandVinculacionNutricionistas: () => void,
  expandSistema: () => void,
): PageGuideStep[] {
  return [
    {
    ...
    },
    {
      ...
      onBeforeShow: expandVinculacionNutricionistas,
    },
    {
      id: 'profile-sistema',

          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className={`rounded-xl border-2 p-4 space-y-3 ${!isPro ? 'border-slate-300 bg-slate-50' : 'border-slate-100 bg-slate-50 opacity-60'}`}>
              ...
              <ul className="space-y-1.5 text-sm text-slate-600">
                ...
                <li className="flex items-center gap-2"><AlertCircle className="w-4 h-4 text-slate-300 shrink-0" /><span className="line-through text-slate-400">IA para menús y laboratorios</span></li>
              </ul>
            </div>
            ...
            <div className={`rounded-xl border-2 p-4 space-y-3 ${isPro ? 'border-emerald-400 bg-emerald-50' : 'border-emerald-200 bg-white'}`}>
              ...
              <ul className="space-y-1.5 text-sm text-slate-700">
                ...
                <li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-emerald-500 shrink-0" /> IA para menús y laboratorios</li>

...
export const ProfileView: React.FC<Props> = ({
  ...
  async function handleSaveGoal() {
    ...
    try {
      await supabase
        .from("patients")
        .update({ portal_goal: goalText || null })
        .eq("id", patient.id);
          ...
          <div className="px-5 pb-8 flex flex-col items-center text-center">
            ...
            >
              <span
                ...
                style={{ color: "#6EE7B7", fontSize: "34px", lineHeight: 1 }}
              >
      ...
      <div className="px-4 pt-4 pb-8 space-y-3">
        ...
        >
          ...
          {editingGoal ? (
            ...
            <p
              ...
              style={{
                color: goalText ? "#374151" : "#9CA3AF",
                fontStyle: goalText ? "normal" : "italic",
              }}
            >
              {goalText ||
                "Sin objetivo definido aún. Toca Editar para agregar el tuyo."}
            </p>
          )}
        </div>
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex-1 min-w-0">
              <p
                ...
                style={{ color: "#1A2E25", fontSize: "15px" }}
              >
              ...
              {nutritionist.specialty && (
                <p
                  ...
                  style={{ color: "#6B7C73", fontSize: "12px" }}
                >
                  {nutritionist.specialty}
                </p>
              )}
          ...
          {(nutritionist.personalPhone ||
            ...
            <div className="flex gap-2">
              {nutritionist.personalPhone && (
                ...
                >
                  ...
                  <span
                    ...
                    style={{ color: "#25D366", fontSize: "11px" }}
                  >
                    WhatsApp
                  </span>
                </a>
              ...
              {nutritionist.website && (
                <a
                  href={
                    nutritionist.website.startsWith("http")
                      ? nutritionist.website
                      : `https://${nutritionist.website}`
                  }
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 flex flex-col items-center gap-1.5 py-3 rounded-2xl transition-opacity active:opacity-70"
                ...
                >
                  ...
                  <span
                    className="font-semibold"
                    style={{ color: "#4F46E5", fontSize: "11px" }}
                  >
                    Sitio web
                  </span>
                </a>
              ...
              {nutritionist.instagram && (
                ...
                >
                  ...
                  <span
                    className="font-semibold"
                    style={{ color: "#E1306C", fontSize: "11px" }}
                  >
                    Instagram
                  </span>
                </a>
        ...
        >
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span
                className="font-semibold"
                style={{ color: "#1A2E25", fontSize: "13px" }}
              >
                Zona horaria
              </span>
              {tzSaved && (
            ...
            <p className="mb-2" style={{ color: "#9CA3AF", fontSize: "11px" }}>
              Asegúrate de que coincida con tu ubicación para que los días del
              plan se calculen correctamente.
            </p>
            <select
              value={timezone}
        ...
        >
          ...
          <p
            ...
            style={{ color: "#1A2E25", fontSize: "13px" }}
          >
            Guarda esta página como app en tu celular
          </p>
          <div className="space-y-2">
            ...
            >
              <p
                ...
                style={{ color: "#1A2E25", fontSize: "11px" }}
              >
                iPhone (Safari)
              </p>
              <ol
            ...
            >
              ...
              >
                ...
                <li>
                  Toca los <span className="font-semibold">3 puntos</span>{" "}
                  (arriba derecha)
                </li>
                <li>
                  Selecciona{" "}
